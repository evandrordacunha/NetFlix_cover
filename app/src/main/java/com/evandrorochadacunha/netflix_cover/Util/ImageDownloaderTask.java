...
import com.evandrorochadacunha.netflix_cover.R;
...
public class ImageDownloaderTask extends AsyncTask<String, Void, Bitmap> {
    ...
    //    Uma referencia para a ImageVIew onde ficarão as imagens
...
//        Ver se não está sendo cancelada a exibição
        if (isCancelled())
//       Zerar o bitmap
            bitmap = null;
        ImageView imageView = imageViewWeakReference.get();
//        Tratando para que as imagens sejam expandidas na mesma proporção
